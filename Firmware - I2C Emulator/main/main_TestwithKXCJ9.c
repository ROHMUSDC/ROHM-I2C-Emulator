...
#define timerVal	20
							 ...
							 // 2343 = 5minutes / 128ms (length of existing timer)
							 // 938 = 2min
							 // 1875 = 4minutes / 128ms
 ...
 */
const unsigned char KXCJ9_I2C_ADDR			= 0x0eu;
const unsigned char KXCJ9_CTRLREG1			= 0x1bu;
const unsigned char KXCJ9_CTRLREG1_CFGOFF	= 0x00u;
const unsigned char KXCJ9_CTRLREG2			= 0x1du;
const unsigned char KXCJ9_CTRLREG2_RESET	= 0x80u;
const unsigned char KXCJ9_CTRLREG1_CFGDAT	= 0x02u;
const unsigned char KXCJ9_CTRLREG1_CFGON	= 0x82u;
const unsigned char KXCJ9_INTCTRLREG1		= 0x1eu;
const unsigned char KXCJ9_INTCTRLREG1_CFGDAT = 0x28u;
const unsigned char KXCJ9_INTCTRLREG2		= 0x1fu;
const unsigned char KXCJ9_INTCTRLREG2_CFGDAT = 0x02u;	//0x02 for only -z
const unsigned char KXCJ9_DATCTRLREG2		= 0x21u;
const unsigned char KXCJ9_DATCTRLREG2_CFGDAT = 0x08u;
const unsigned char KXCJ9_WAKEUPTIMER		= 0x29u;
const unsigned char KXCJ9_WAKEUPTIMER_CFGDAT = 0x01u;
const unsigned char KXCJ9_SELFTEST			= 0x3au;
const unsigned char KXCJ9_SELFTEST_CFGDAT	= 0x00u;
const unsigned char KXCJ9_ZOUTL				= 0x0au;
const unsigned char KXCJ9_INT_REL			= 0x1Au;
const unsigned char KXCJ9_INTSOURCE1		= 0x16u;

const unsigned char KXCJ9_WAKEUPTHRES_CFGDAT = 0x00u;
const unsigned char KXCJ9_WAKEUPTHRES		= 0x6Au;
...
MainLoop:
	...
	if(_flgPB2Int == 1){
		...
		I2C_Read(KXCJ9_I2C_ADDR, &KXCJ9_INT_REL, 1, uniRawSensorOut._ucharArr, 1);
		
		I2C_Write(KXCJ9_I2C_ADDR, &KXCJ9_CTRLREG2, 1, &KXCJ9_CTRLREG2_RESET, 1);
		I2C_Read(KXCJ9_I2C_ADDR, &KXCJ9_CTRLREG2, 1, uniRawSensorOut._ucharArr, 1);
		while(uniRawSensorOut._ucharArr[0] != 0x0){
			I2C_Read(KXCJ9_I2C_ADDR, &KXCJ9_CTRLREG2, 1, uniRawSensorOut._ucharArr, 1);	
		}
		
		I2C_Write(KXCJ9_I2C_ADDR, &KXCJ9_CTRLREG1, 1, &KXCJ9_CTRLREG1_CFGOFF, 1);
		I2C_Write(KXCJ9_I2C_ADDR, &KXCJ9_CTRLREG1, 1, &KXCJ9_CTRLREG1_CFGDAT, 1);
		I2C_Write(KXCJ9_I2C_ADDR, &KXCJ9_SELFTEST, 1, &KXCJ9_SELFTEST_CFGDAT, 1);
		I2C_Write(KXCJ9_I2C_ADDR, &KXCJ9_INTCTRLREG1, 1, &KXCJ9_INTCTRLREG1_CFGDAT, 1);
		I2C_Write(KXCJ9_I2C_ADDR, &KXCJ9_INTCTRLREG2, 1, &KXCJ9_INTCTRLREG2_CFGDAT, 1);
		I2C_Write(KXCJ9_I2C_ADDR, &KXCJ9_DATCTRLREG2, 1, &KXCJ9_DATCTRLREG2_CFGDAT, 1);
		I2C_Write(KXCJ9_I2C_ADDR, &KXCJ9_WAKEUPTIMER, 1, &KXCJ9_WAKEUPTIMER_CFGDAT, 1);
		I2C_Write(KXCJ9_I2C_ADDR, &KXCJ9_WAKEUPTHRES, 1, &KXCJ9_WAKEUPTHRES_CFGDAT, 1);
		
		//Turn On
		I2C_Write(KXCJ9_I2C_ADDR, &KXCJ9_CTRLREG1, 1, &KXCJ9_CTRLREG1_CFGON, 1);
		
		//I2C_Read(KMX61_I2C_ADDR, &KXCJ9_INTSOURCE1, 1, uniRawSensorOut._ucharArr, 1);
		/*
	...
	flSensorOut[2] = (float)uniRawSensorOut._intArr[2]/1024.0f;	// Z
	*/
	I2C_Read(KXCJ9_I2C_ADDR, &KXCJ9_ZOUTL, 1, uniRawSensorOut._ucharArr, 2);
	uniRawSensorOut._intArr[0] = uniRawSensorOut._intArr[0]>>2;
	flSensorOut[0] = (float)uniRawSensorOut._intArr[0]/1024.0f;	// Z
		
	if(flSensorOut[0] <= -0.8f){
		if(DoorOpen == 0){
			DoorOpen = 1;
			tm_init(TM_CH_NO_AB);
...
static void SetOSC(void){
	...
	SYSC1 = 1;			// setting HS Clock to 1/8 aka 1.024MHz
